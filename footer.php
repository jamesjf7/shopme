<button class="position-fixed btn btn-secondary text-white text-center mr-4 z-1" style="width:10%;bottom:0;right:0;" onclick="window.location.href='chat.php'">
  Chat
</button>
  ...
  <div class="social-links-warp">
   <div class="container">
    <div class="social-links">
     ...
     <a href="" class="google-plus"><i class="fab fa-google-plus"></i><span>g+plus</span></a>
